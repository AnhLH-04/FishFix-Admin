...
//             <span className="bg-gradient-to-r from-[#007BFF] to-purple-600 bg-clip-text text-transparent">FishFix</span>
//           </CardTitle>
//           <CardDescription className="text-base">Đăng nhập vào Admin Dashboard</CardDescription>
//         </CardHeader>
...
//               <p>
//                 <span className="font-medium">Email:</span> admin@FishFix.vn
//               </p>
//               <p>
...
//             <p className="text-xs text-gray-500">© 2025 FishFix. Bảo mật và riêng tư.</p>
//           </div>
//         </CardContent>
//       </Card>
